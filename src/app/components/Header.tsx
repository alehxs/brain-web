    ...
    >
      ...
      <div className="flex items-center gap-4 border-l border-white/30 pl-6 py-1">
        ...
        <div className="hidden md:block text-left leading-tight opacity-80">
          <span className="block text-[0.65rem] uppercase tracking-widest font-semibold">
            Supported by
          </span>
          <span className="block text-[0.65rem] uppercase tracking-widest font-semibold">
                    ...
                    <>
                      ...
                      >
                        <span
                          className={`relative ${
                            openMenu === item.label
                              ? "text-[var(--luminous-mint)]"
                              : "text-white/90 group-hover:text-[var(--luminous-mint)]"
                          }`}
                        >
                          {item.label}
                        </span>
                        <ChevronDown
                          className={`w-[0.7em] h-[0.7em] transition-transform ${openMenu === item.label ? "rotate-180" : ""} ${
                            openMenu === item.label
                              ? "text-[var(--luminous-mint)]"
                              : "text-white/90 group-hover:text-[var(--luminous-mint)]"
                          }`}
                    ...
                    <>
                      ...
                      >
                        ...
                        {isExternal(item.href) && (
                          <ExternalArrow className="w-3 h-3 text-white/60 group-hover:text-[var(--luminous-mint)] transition-colors" />
                        )}
                      </Link>
                    </>
                  )}
              ...
              >
                {isNavGroup(item) ? (
                  ...
                  >
                    ...
                    {isExternal(item.href) && (
                      <ExternalArrow className="w-4 h-4 opacity-60" />
                    )}
                  </Link>
                )}
              </li>
